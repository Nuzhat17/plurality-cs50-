...
bool vote(string name)
{
    ...
    {
        if (strcmp(name, candidates[currcandidate].name) == 0) //compare the voters vote to name
...
void print_winner(void)
{
    ...
    {
        if (topCandidateVotes < candidates[currcandidate].votes)
        {
            topCandidateVotes = candidates[currcandidate].votes;
        }
    ...
    {
        if (candidates[currcandidate].votes == topCandidateVotes)
        {
